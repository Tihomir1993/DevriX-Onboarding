...
var slConfig = require('sass-lint/lib/config'),
    groot = require('sass-lint/lib/groot'),
    exceptions = require('sass-lint/lib/exceptions'),
    helpers = require('sass-lint/lib/helpers'),
    slRules = require('sass-lint/lib/rules'),
    ruleToggler = require('sass-lint/lib/ruleToggler'),
    glob = require('glob'),
    path = require('path'),
    fs = require('fs-extra'),
...
var sassLint = function (config) { // eslint-disable-line no-unused-vars
  config = require('sass-lint/lib/config')(config);
  return;
};
